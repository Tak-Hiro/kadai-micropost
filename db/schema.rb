...
ActiveRecord::Schema.define(version: 20180321051142) do
  ...
  create_table "connections", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["favorite_id"], name: "index_connections_on_favorite_id", using: :btree
    t.index ["user_id", "favorite_id"], name: "index_connections_on_user_id_and_favorite_id", unique: true, using: :btree
  ...
  add_foreign_key "connections", "users", column: "favorite_id"
